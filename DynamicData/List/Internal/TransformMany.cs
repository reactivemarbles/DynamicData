...
namespace DynamicData.List.Internal
{
    internal sealed class TransformMany<TSource, TDestination>
    {
        ...
        //make this an instance
        private sealed class SubsequentChangeEnumerator : IEnumerable<Change<TDestination>>
        {
            private readonly IChangeSet<ManyContainer> _changes;
            private readonly IEqualityComparer<TDestination> _equalityComparer;

            public SubsequentChangeEnumerator(IChangeSet<ManyContainer> changes, IEqualityComparer<TDestination> equalityComparer)
            {
                _changes = changes;
                _equalityComparer = equalityComparer;
            }
