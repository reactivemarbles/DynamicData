...
namespace DynamicData
{
	...
	public class UnspecifiedIndexException : Exception
	{
		...
		public UnspecifiedIndexException(string message) : base(message)
		{
		}
		...
		public UnspecifiedIndexException(string message, Exception innerException) : base(message, innerException)
		{
		}
	}
