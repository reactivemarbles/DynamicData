namespace DynamicData
{
    ...
    public class ParallelisationOptions
    {
        ...
        /// </summary>
        public readonly static ParallelisationOptions Default = new ParallelisationOptions(ParallelType.Parallelise,0);
        ...
        /// </summary>
        public ParallelisationOptions(ParallelType type=ParallelType.None, int threshold=0)
        {
            _type = type;
