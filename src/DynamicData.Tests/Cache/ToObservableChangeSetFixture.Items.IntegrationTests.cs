    ...
    public static partial class Items
    {
            ...
            : IntegrationTestFixtureBase
        {
            ...
            public async Task MultipleSubscriptionsRunInParallel_SchedulerUsageIsThreadSafe(SchedulerType schedulerType, CancellationToken cancellationToken)
            {
                ...
                await Assert.That(results1.RecordedItemsByKey).IsEmpty().Because("all items should have expired");
                ...
                await Assert.That(results2.RecordedItemsByKey).IsEmpty().Because("all items should have expired");
            }
        }
    }
}
