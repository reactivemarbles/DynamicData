...
public class OnItemRefreshedFixture
{
    ...
    [Arguments(5, 2)]
    [Arguments(5, 5)]
    public async Task ItemIsAdded_RefreshActionIsNotInvoked(
        ...
        int insertionIndex)
    {
        ...
        await Assert.That(refreshActionInvocations).IsEmpty().Because("no items were refreshed within the collection");
    ...
    [Arguments(5, 1, 3)]
    [Arguments(5, 3, 1)]
    public async Task ItemIsMoved_RefreshActionIsNotInvoked(
        int initialItemCount,
        int originalIndex,
        int destinationIndex)
    {
        ...
        await Assert.That(refreshActionInvocations).IsEmpty().Because("no items were removed from the collection");
    }
    ...
    [Arguments(5, 2)]
    [Arguments(5, 4)]
    public async Task ItemIsRefreshed_RefreshActionIsNotInvoked(
        int initialItemCount,
        int refreshIndex)
    {
        using var source = new TestSourceList<int>();
        ...
        await Assert.That(refreshActionInvocations).IsEquivalentTo(new[] { refreshedItem }).Because("1 item were refreshed within the collection");
    }
    ...
    [Arguments(5, 2)]
    [Arguments(5, 4)]
    public async Task ItemIsRemoved_RefreshActionIsInvoked(
        int initialItemCount,
        int removalIndex)
    {
        using var source = new TestSourceList<int>();
    ...
    [Arguments(5, 2)]
    [Arguments(5, 4)]
    public async Task ItemIsReplaced_RefreshActionIsInvokedForOldItem(
        int initialItemCount,
    ...
    [Arguments(5, 1, 3)]
    [Arguments(5, 0, 5)]
    public async Task ItemRangeIsRemoved_RefreshActionIsInvokedForEachItem(
        int initialItemCount,
        int removalIndex,
        int removalCount)
    {
    ...
    [Arguments(1)]
    [Arguments(5)]
    public async Task ItemsAreCleared_RefreshActionIsInvokedForEachItem(int initialItemCount)
    {
        using var source = new TestSourceList<int>();
    ...
    public async Task SourceCompletesAsynchronously_CompletionPropagates()
    {
        ...
        await Assert.That(refreshActionInvocations).IsEmpty().Because("no items have been removed from the collection");
