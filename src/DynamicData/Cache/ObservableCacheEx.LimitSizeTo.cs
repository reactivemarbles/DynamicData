...
public static partial class ObservableCacheEx
{
    ...
    /// <param name="source">The source <c>IObservable&lt;IChangeSet&lt;TObject, TKey&gt;&gt;</c> to apply size limits to.</param>
    ...
    /// <summary>
    /// Operates directly on a <c>ISourceCache&lt;TObject, TKey&gt;</c>, removing the oldest items when the cache
