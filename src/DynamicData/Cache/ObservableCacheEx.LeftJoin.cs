...
public static partial class ObservableCacheEx
{
    ...
    ///   <item><term>Add</term><description>Always emits. Invokes <paramref name="resultSelector"/> with the left value and matching right (or <see cref="ReactiveUI.Primitives.Optional.None{T}"/>).</description></item>
