...
{
    /// <summary>
    /// Provides an overload of <c>LeftJoinMany</c> for the supplied arguments.
    /// </summary>
    ...
    /// <remarks>Overload that omits the key from the result selector. Delegates to <c>LeftJoinMany&lt;TLeft, TLeftKey, TRight, TRightKey, TDestination&gt;(IObservable&lt;IChangeSet&lt;TLeft, TLeftKey&gt;&gt;, IObservable&lt;IChangeSet&lt;TRight, TRightKey&gt;&gt;, Func&lt;TRight, TLeftKey&gt;, Func&lt;TLeftKey, TLeft, IGrouping&lt;TRight, TRightKey, TLeftKey&gt;, TDestination&gt;)</c>.</remarks>
