...
public static partial class ObservableCacheEx
{
    ...
    /// <inheritdoc cref="TransformSafeAsync{TDestination, TSource, TKey}(IObservable{IChangeSet{TSource, TKey}}, Func{TSource, ReactiveUI.Primitives.Optional{TSource}, TKey, CancellationToken, Task{TDestination}}, Action{Error{TSource, TKey}}, IObservable{Func{TSource, TKey, bool}}?)"/>
    [SuppressMessage("Roslynator", "RCS1047:Non-asynchronous method name should not end with 'Async'.", Justification = "By Design.")]
        ...
        where TKey : notnull
    {
        ...
        return source.TransformSafeAsync((current, previous, key, _) => transformFactory(current, previous, key), errorHandler, options);
    }
