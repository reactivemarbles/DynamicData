...
public static partial class ObservableCacheEx
{
    ...
    /// <param name="adaptor">The <see cref="IChangeSetAdaptor{TObject, TKey}"/> adaptor.</param>
    ...
    /// <param name="adaptor">The <see cref="ISortedChangeSetAdaptor{TObject, TKey}"/> adaptor.</param>
    /// <returns>An observable which will emit change sets.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    /// or
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> source.</param>
    ...
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> source.</param>
    /// <param name="item">The item.</param>
    /// <param name="equalityComparer">An <see cref="IEqualityComparer{T}"/> equality comparer used to determine whether a new item is the same as an existing cached item.</param>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> source.</param>
    /// <param name="items">An <see cref="IEnumerable{T}"/> items.</param>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="IIntermediateCache{TObject, TKey}"/> source cache.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="others">The other <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams.</param>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="sources">An <see cref="ICollection{T}"/> of <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams. source.</param>
    /// <returns>An observable which emits change sets.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    /// or
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="sources">An <see cref="IObservableList{T}"/> of <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams. source.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="sources">An <see cref="IObservableList{T}"/> of <see cref="IObservableCache{TObject, TKey}"/> instances. source.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="sources">An <see cref="IObservableList{T}"/> of <see cref="ISourceCache{TObject, TKey}"/> instances. source.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="IObservableCache{TObject, TKey}"/> source.</param>
    ...
    /// <para>
    /// An <see cref="Action{T}"/> to be invoked upon each subscription to this operator, allowing the consumer access to the "disposalsCompleted" stream for that subscription.
    /// </para>
    /// <para>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Observable.</param>
    /// <param name="changeSetBuffer">A <see cref="TimeSpan"/> Batch up changes by specifying the buffer. This greatly increases performance when many elements have successive property changes.</param>
    /// <param name="propertyChangeThrottle">A <see cref="TimeSpan"/> When observing on multiple property changes, apply a throttle to prevent excessive refresh invocations.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler.</param>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Observable.</param>
    /// <param name="propertyAccessor">An <see cref="Expression{TDelegate}"/> Specify a property to observe changes. When it changes a Refresh is invoked.</param>
    /// <param name="changeSetBuffer">A <see cref="TimeSpan"/> Batch up changes by specifying the buffer. This greatly increases performance when many elements have successive property changes.</param>
    /// <param name="propertyChangeThrottle">A <see cref="TimeSpan"/> When observing on multiple property changes, apply a throttle to prevent excessive refresh invocations.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler.</param>
    /// <returns>An observable change set with additional refresh changes.</returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Observable change set.</param>
    /// <param name="reevaluator">A <see cref="Func{T, TResult}"/> observable which acts on items within the collection and produces a value when the item should be refreshed.</param>
    /// <param name="changeSetBuffer">A <see cref="TimeSpan"/> Batch up changes by specifying the buffer. This greatly increases performance when many elements require a refresh.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler.</param>
    /// <returns>An observable change set with additional refresh changes.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="timeSpan">A <see cref="TimeSpan"/> time span.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="pauseIfTrueSelector">An <see cref="IObservable{T}"/> of bool. When true, observable begins to buffer and when false, window closes and buffered result if notified.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler.</param>
    /// <returns>An observable which emits change sets.</returns>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="pauseIfTrueSelector">An <see cref="IObservable{T}"/> of bool. When true, observable begins to buffer and when false, window closes and buffered result if notified.</param>
    /// <param name="timeOut">A <see cref="TimeSpan"/> Specify a time to ensure the buffer window does not stay open for too long. On completion buffering will cease.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler.</param>
    /// <returns>An observable which emits change sets.</returns>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <param name="pauseIfTrueSelector">An <see cref="IObservable{T}"/> of bool. When true, observable begins to buffer and when false, window closes and buffered result if notified.</param>
    /// <param name="initialPauseState">if set to <c>true</c> [initial pause state].</param>
    /// <param name="timer">An <see cref="IObservable{T}"/> of <see cref="Unit"/> Specify a time observable. The buffer will be emptied each time the timer produces a value and when it completes. On completion buffering will cease.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler.</param>
    /// <returns>An observable which emits change sets.</returns>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="destination">The <see cref="IObservableCollection{T}"/> destination.</param>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="destination">The <see cref="IObservableCollection{T}"/> destination.</param>
    /// <param name="options">The <see cref="BindingOptions"/> binding options.</param>
    /// <returns>An observable which will emit change sets.</returns>
    /// <exception cref="System.ArgumentNullException">source.</exception>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="destination">The <see cref="IObservableCollection{T}"/> destination.</param>
    /// <param name="updater">The <see cref="IObservableCollectionAdaptor{TObject, TKey}"/> updater.</param>
    /// <returns>An observable which will emit change sets.</returns>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <param name="adaptor">The <see cref="IObservableCollectionAdaptor{TObject, TKey}"/> Specify an adaptor to change the algorithm to update the target collection.</param>
    /// <returns>An observable which will emit change sets.</returns>
    /// <exception cref="System.ArgumentNullException">source.</exception>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="ISortedChangeSet{TObject, TKey}"/>.</param>
    /// <param name="destination">The <see cref="IObservableCollection{T}"/> destination.</param>
    /// <param name="updater">The <see cref="ISortedObservableCollectionAdaptor{TObject, TKey}"/> updater.</param>
    /// <returns>An observable which will emit change sets.</returns>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <param name="useReplaceForUpdates"> Use replace instead of remove / add for updates.  NB: Some platforms to not support replace notifications for binding.</param>
    /// <param name="adaptor">The <see cref="ISortedObservableCollectionAdaptor{TObject, TKey}"/> Specify an adaptor to change the algorithm to update the target collection.</param>
    /// <returns>An observable which will emit change sets.</returns>
    /// <exception cref="System.ArgumentNullException">source.</exception>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="bindingList">The <see cref="BindingList{T}"/> target binding list.</param>
    ...
    /// <typeparam name="TObject">The object type.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Change set.</param>
    /// <param name="initialBuffer">A <see cref="TimeSpan"/> period to buffer, measure from the time that the first item arrives.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler to buffer on.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="converter">A <see cref="Func{T, TResult}"/> conversion factory.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="keySelector">A <see cref="Func{T, TResult}"/> key selector eg. (item) => newKey.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <typeparam name="TDestinationKey">The type of the destination key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="keySelector">A <see cref="Func{T, TResult}"/> key selector eg. (key, item) => newKey.</param>
    /// <returns>An observable which emits change sets.</returns>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="IIntermediateCache{TObject, TKey}"/> source.</param>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="LockFreeObservableCache{TObject, TKey}"/> source.</param>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="target">The <see cref="ICollection{T}"/> target.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <typeparam name="TDestination">The type of the destination.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="conversionFactory">A <see cref="Func{T, TResult}"/> conversion factory.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="valueSelector">A <see cref="Func{T, TResult}"/> value selector.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> source.</param>
    /// <param name="allItems">An <see cref="IEnumerable{T}"/> items to add, update or delete.</param>
    /// <param name="equalityComparer">An <see cref="IEqualityComparer{T}"/> equality comparer used to determine whether a new item is the same as an existing cached item.</param>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> source.</param>
    /// <param name="allItems">An <see cref="IEnumerable{T}"/> items to compare and add, update or delete.</param>
    /// <param name="areItemsEqual">A <see cref="Func{T, TResult}"/> Expression to determine whether an item's value is equal to the old value (current, previous) => current.Version == previous.Version.</param>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">An <see cref="IObservable{T}"/> of <see cref="IEnumerable{T}"/> source.</param>
    /// <param name="keySelector">A <see cref="Func{T, TResult}"/> Key Selection Function for the ChangeSet.</param>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">An <see cref="IObservable{T}"/> source.</param>
    /// <param name="keySelector">A <see cref="Func{T, TResult}"/> Key Selection Function for the ChangeSet.</param>
    /// <param name="equalityComparer">Optional <see cref="IEqualityComparer{T}"/> instance to use for comparing values.</param>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="sources">An <see cref="ICollection{T}"/> of <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams. sources.</param>
    /// <returns>An observable which emits change sets.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    /// or
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="timeSelector">A <see cref="Func{T, TResult}"/> time selector.</param>
    /// <returns>An observable which emits change sets.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    /// or
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="timeSelector">A <see cref="Func{T, TResult}"/> time selector.  Return null if the item should never be removed.</param>
    /// <param name="pollingInterval">A <see cref="TimeSpan"/> polling interval. If this value is specified, items are expired on an interval.
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> cache.</param>
    /// <param name="timeSelector">A <see cref="Func{T, TResult}"/> time selector.  Return null if the item should never be removed.</param>
    /// <param name="pollingInterval">A <see cref="TimeSpan"/> polling interval. Since multiple timer subscriptions can be expensive,
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="filter">A <see cref="Func{T, TResult}"/> filter.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="predicateChanged">An <see cref="IObservable{T}"/> of <see cref="Func{T, TResult}"/>. Observable to change the underlying predicate.</param>
    /// <param name="suppressEmptyChangeSets">By default empty changeset notifications are suppressed for performance reasons.  Set to false to publish empty changesets.  Doing so can be useful for monitoring loading status.</param>
    /// <returns>An observable which emits change sets.</returns>
    public static IObservable<IChangeSet<TObject, TKey>> Filter<TObject, TKey>(
                this IObservable<IChangeSet<TObject, TKey>> source,
    ...
    /// <param name="predicate">A <see cref="Func{T, TResult}"/> static predicate to be used to determine which items should be included or excluded by the filter.</param>
    /// <param name="suppressEmptyChangeSets">By default empty changeset notifications are suppressed for performance reasons.  Set to false to publish empty changesets.  Doing so can be useful for monitoring loading status.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="predicateChanged">An <see cref="IObservable{T}"/> of <see cref="Func{T, TResult}"/>. Observable to change the underlying predicate.</param>
    /// <param name="reapplyFilter">An <see cref="IObservable{T}"/> of <see cref="Unit"/> Observable to re-evaluate whether the filter still matches items. Use when filtering on mutable values.</param>
    /// <param name="suppressEmptyChangeSets">By default empty changeset notifications are suppressed for performance reasons.  Set to false to publish empty changesets.  Doing so can be useful for monitoring loading status.</param>
    /// <returns>An observable which emits change sets.</returns>
    public static IObservable<IChangeSet<TObject, TKey>> Filter<TObject, TKey>(
                this IObservable<IChangeSet<TObject, TKey>> source,
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Stream of collection items to be filtered.</param>
    /// <param name="predicate">A <see cref="Func{T, TResult}"/> filtering predicate to be applied to each item.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="filterFactory">A <see cref="Func{T, TResult}"/> Factory function used to create the observable bool that controls whether that given item passes the filter or not.</param>
    /// <param name="buffer">A <see cref="TimeSpan"/> Optional time to buffer changes from the observable bools.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> Optional scheduler to use when buffering the changes.</param>
    ...
    /// <param name="source">An <see cref="IObservable{T}"/> source.</param>
    /// <param name="finallyAction">An <see cref="Action"/> finally action.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="action">An <see cref="Action{T}"/> action.</param>
    ...
    /// <param name="left">The left <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> data source.</param>
    /// <param name="right">The right <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> data source.</param>
    /// <param name="rightKeySelector">A <see cref="Func{T, TResult}"/> Specify the foreign key on the right data source.</param>
    /// <param name="resultSelector">A <see cref="Func{T, TResult}"/> result selector.used to transform the combined data into. Example (key, left, right) => new CustomObject(key, left, right).</param>
    /// <returns>An observable which will emit change sets.</returns>
    ...
    /// <param name="right">The right <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> data source.</param>
    /// <param name="rightKeySelector">A <see cref="Func{T, TResult}"/> Specify the foreign key on the right data source.</param>
    /// <param name="resultSelector">A <see cref="Func{T, TResult}"/> result selector.used to transform the combined data into. Example (left, right) => new CustomObject(key, left, right).</param>
    /// <returns>An observable which will emit change sets.</returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="groupSelector">A <see cref="Func{T, TResult}"/> group selector factory.</param>
    /// <param name="resultGroupSource">
    ///   An <see cref="IObservable{T}"/> of <see cref="IDistinctChangeSet{TValue}"/> used to determine the result groups.
    /// </param>
    /// <remarks>
    ...
    /// <typeparam name="TGroupKey">The type of the group key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="groupSelectorKey">A <see cref="Func{T, TResult}"/> group selector key.</param>
    /// <returns>An observable which will emit group change sets.</returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="groupSelectorKey">A <see cref="Func{T, TResult}"/> group selector key.</param>
    /// <param name="regrouper">An <see cref="IObservable{T}"/> of <see cref="Unit"/> Invoke to  the for the grouping to be re-evaluated.</param>
    /// <returns>An observable which will emit group change sets.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    /// or
    ...
    /// <typeparam name="TGroupKey">The type of the group key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="groupSelectorKeyObservable">An <see cref="IObservable{T}"/> of <see cref="Func{T, TResult}"/>. group selector key observable.</param>
    /// <param name="regrouper">An <see cref="IObservable{T}"/> of <see cref="Unit"/> Fires when the current Grouping Selector needs to re-evaluate all the items in the cache.</param>
    /// <returns>An observable which will emit group change sets.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    /// or
    ...
    /// <typeparam name="TGroupKey">The type of the group key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="groupObservableSelector">A <see cref="Func{T, TResult}"/> group selector key.</param>
    /// <returns>An observable which will emit group change sets.</returns>
    ...
    /// <typeparam name="TGroupKey">The type of the group key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="propertySelector">An <see cref="Expression{TDelegate}"/> property selector used to group the items.</param>
    /// <param name="propertyChangedThrottle">A <see cref="TimeSpan"/> time span that indicates the throttle to wait for property change events.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler.</param>
    ...
    /// <typeparam name="TObject">The object of the change set.</typeparam>
    /// <typeparam name="TKey">The key of the change set.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Observable which emits change sets.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="ignoreFunction">A <see cref="Func{T, TResult}"/> ignore function (current,previous)=>{ return true to ignore }.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="includeFunction">A <see cref="Func{T, TResult}"/> include function (current,previous)=>{ return true to include }.</param>
    /// <returns>An observable which emits change sets and ignores updates equal to the lambda.</returns>
    ...
    /// <typeparam name="TDestination">The type of the destination.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="observableSelector">A <see cref="Func{T, TResult}"/> observable selector.</param>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">An <see cref="IObservable{T}"/> of <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams. Source Observable ChangeSet.</param>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Observable ChangeSet.</param>
    /// <param name="other">The other <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Observable ChangeSet.</param>
    /// <param name="others">An <see cref="IEnumerable{T}"/> of <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams. Other Observable ChangeSets.</param>
    /// <param name="scheduler">(Optional) <see cref="IScheduler"/> instance to use when enumerating the collection.</param>
    /// <param name="completable">Whether or not the result Observable should complete if all the changesets complete.</param>
    /// <returns>The result from merging the changesets together.</returns>
    /// <exception cref="ArgumentNullException">Parameter was null.</exception>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">An <see cref="IEnumerable{T}"/> of <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams. Source Observable ChangeSet.</param>
    /// <param name="scheduler">(Optional) <see cref="IScheduler"/> instance to use when enumerating the collection.</param>
    /// <param name="completable">Whether or not the result Observable should complete if all the changesets complete.</param>
    /// <returns>The result from merging the changesets together.</returns>
    /// <exception cref="ArgumentNullException">Parameter was null.</exception>
    ...
    /// <typeparam name="TDestinationKey">The type of the destination key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Observable ChangeSet.</param>
    /// <param name="observableSelector">A <see cref="Func{T, TResult}"/> Factory Function used to create child changesets.</param>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Observable changeset of <typeparamref name="tobject"/> instances.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="addAction">An <see cref="Action{T}"/> add action that takes the new value and the associated key.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="addAction">An <see cref="Action{T}"/> add action that takes the new value.</param>
    /// <returns>An observable which emits a change set with items being added.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="refreshAction">An <see cref="Action{T}"/> refresh action that takes the refreshed value and the key.</param>
    /// <returns>An observable which emits a change set with items being added.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="refreshAction">An <see cref="Action{T}"/> refresh action that takes the refreshed value.</param>
    /// <returns>An observable which emits a change set with items being added.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="removeAction">An <see cref="Action{T}"/> remove action that takes the removed value and the key.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="removeAction">An <see cref="Action{T}"/> remove action that takes the removed value.</param>
    /// <param name="invokeOnUnsubscribe"> Should the remove action be invoked when the subscription is disposed.</param>
    /// <returns>An observable which emits a change set with items being removed.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="updateAction">An <see cref="Action{T}"/> update action that takes current value, previous value, and the key.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="updateAction">An <see cref="Action{T}"/> update action that takes the current value and previous value.</param>
    /// <returns>An observable which emits a change set with items being updated.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> source.</param>
    /// <param name="observable">An <see cref="IObservable{T}"/> of <see cref="IEnumerable{T}"/> observable.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> source.</param>
    /// <param name="observable">An <see cref="IObservable{T}"/> observable.</param>
    /// <returns>A disposable which will unsubscribe from the source.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    /// or
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="destination">The <see cref="ISourceCache{TObject, TKey}"/> destination.</param>
    /// <returns>A disposable which will unsubscribe from the source.</returns>
    /// <exception cref="ArgumentNullException">
    /// source
    /// or
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="destination">The <see cref="IIntermediateCache{TObject, TKey}"/> destination.</param>
    /// <returns>A disposable which will unsubscribe from the source.</returns>
    /// <exception cref="ArgumentNullException">source
    /// or
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="destination">The <see cref="LockFreeObservableCache{TObject, TKey}"/> destination.</param>
    /// <returns>A disposable which will unsubscribe from the source.</returns>
    ...
    /// <typeparam name="TDestination">The type of the destination.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="resultSelector">A <see cref="Func{T, TResult}"/> result selector.</param>
    ...
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="itemChangedTrigger">A <see cref="Func{T, TResult}"/> Should the query be triggered for observables on individual items.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The <see cref="ISourceCache{TObject, TKey}"/> source.</param>
    /// <param name="keys">An <see cref="IEnumerable{T}"/> keys.</param>
    /// <exception cref="ArgumentNullException">source.</exception>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="comparer">An <see cref="IComparer{T}"/> comparer.</param>
    /// <param name="sortOptimisations">The <see cref="SortOptimisations"/> Sort optimisation flags. Specify one or more sort optimisations.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="comparerObservable">An <see cref="IObservable{T}"/> of <see cref="IComparer{T}"/> which enables the sort order to be changed.</param>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="comparerObservable">An <see cref="IObservable{T}"/> of <see cref="IComparer{T}"/> which enables the sort order to be changed.</param>
    /// <param name="resorter">An <see cref="IObservable{T}"/> of <see cref="Unit"/> Signal to instruct the algorithm to re-sort the entire data set.</param>
    /// <param name="sortOptimisations">The <see cref="SortOptimisations"/> sort optimisations.</param>
    /// <param name="resetThreshold">The reset threshold.</param>
    /// <returns>An observable which emits change sets.</returns>
    [Obsolete(Constants.SortIsObsolete)]
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="comparer">An <see cref="IComparer{T}"/> comparer to sort on.</param>
    /// <param name="resorter">An <see cref="IObservable{T}"/> of <see cref="Unit"/> Signal to instruct the algorithm to re-sort the entire data set.</param>
    /// <param name="sortOptimisations">The <see cref="SortOptimisations"/> sort optimisations.</param>
    /// <param name="resetThreshold">The reset threshold.</param>
    /// <returns>An observable which emits change sets.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="expression">A <see cref="Func{T, TResult}"/> expression.</param>
    ...
    /// <typeparam name="TObject">The object of the change set.</typeparam>
    /// <typeparam name="TKey">The key of the change set.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="ISortedChangeSet{TObject, TKey}"/>. Observable change set.</param>
    ...
    /// <typeparam name="TObject">The object of the change set.</typeparam>
    /// <typeparam name="TKey">The key of the change set.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IVirtualChangeSet{TObject, TKey}"/>. Observable change set.</param>
    ...
    /// <typeparam name="TObject">The object of the change set.</typeparam>
    /// <typeparam name="TKey">The key of the change set.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IPagedChangeSet{TObject, TKey}"/>. Observable change set.</param>
    ...
    /// <param name="source">An <see cref="IObservable{T}"/> source observable change set.</param>
    ...
    /// <param name="source">An <see cref="IObservable{T}"/> source read only collection.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="subscriptionFactory">A <see cref="Func{T, TResult}"/> subscription function.</param>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="sources">An <see cref="IObservable{T}"/> source.</param>
    /// <returns>
    ...
    /// <typeparam name="TObject">The type of the object.</typeparam>
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="sources">An <see cref="IObservable{T}"/> of <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/> streams. source.</param>
    /// <returns>
    /// The observable sequence that at any point in time produces the elements of the most recent inner observable sequence that has been received.
    /// </returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">An <see cref="IObservable{T}"/> source.</param>
    /// <param name="keySelector">A <see cref="Func{T, TResult}"/> key selector.</param>
    /// <param name="expireAfter">A <see cref="Func{T, TResult}"/> Specify on a per object level the maximum time before an object expires from a cache.</param>
    /// <param name="limitSizeTo">Remove the oldest items when the size has reached this limit.</param>
    /// <param name="scheduler">The <see cref="IScheduler"/> scheduler (only used for time expiry).</param>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="sort">A <see cref="Func{T, TResult}"/> sort function.</param>
    /// <param name="sortOrder">The <see cref="SortDirection"/> sort order. Defaults to ascending.</param>
    /// <returns>An observable which emits the read only collection.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="comparer">An <see cref="IComparer{T}"/> sort comparer.</param>
    /// <returns>An observable which emits the read only collection.</returns>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transform factory.</param>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transform factory.</param>
    /// <param name="forceTransform">An <see cref="IObservable{T}"/> of <see cref="Func{T, TResult}"/>. Invoke to force a new transform for items matching the selected objects.</param>
    /// <returns>
    /// A transformed update collection.
    /// </returns>
    /// <exception cref="ArgumentNullException">source
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transform factory.</param>
    /// <param name="forceTransform">An <see cref="IObservable{T}"/> of <see cref="Unit"/> Invoke to force a new transform for all items.</param>
    /// <returns>
    /// A transformed update collection.
    /// </returns>
    /// <exception cref="ArgumentNullException">source
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transform factory.</param>
    /// <param name="options">The <see cref="TransformAsyncOptions"/> transform options.</param>
    /// <returns>
    /// A transformed update collection.
    /// </returns>
    /// <exception cref="ArgumentNullException">source
    ...
    /// <typeparam name="TKey">The type of the key values of each collection item.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Stream of collection items to be transformed.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transformation to be applied to each item.</param>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="manySelector">A <see cref="Func{T, TResult}"/> Will select a enumerable of values.</param>
    /// <param name="keySelector">A <see cref="Func{T, TResult}"/> key selector which must be unique across all.</param>
    ...
    /// <returns>An observable with the transformed change set.</returns>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="manySelector">A <see cref="Func{T, TResult}"/> Will select an observable cache of values.</param>
    /// <param name="keySelector">A <see cref="Func{T, TResult}"/> key selector which must be unique across all.</param>
    ...
    /// <param name="manySelector">Async function to transform a <typeparamref name="TSource"/> and <typeparamref name="TSourceKey"/> into an <see cref="IEnumerable{T}"/> of <typeparamref name="TDestination"/>.</param>
    /// <param name="keySelector">A <see cref="Func{T, TResult}"/> key selector which must be unique across all.</param>
    /// <param name="errorHandler">An <see cref="Action{T}"/> Callback function for handling an errors.</param>
    /// <param name="equalityComparer">Optional <see cref="IEqualityComparer{T}"/> instance to determine if two elements are the same.</param>
    /// <param name="comparer">Optional <see cref="IComparer{T}"/> instance to determine which element to emit if the same key is emitted from multiple child changesets.</param>
    /// <remarks>Because the transformations are asynchronous, unlike TransformMany, each sub-collection could be emitted via a separate changeset.</remarks>
    [SuppressMessage("Roslynator", "RCS1047:Non-asynchronous method name should not end with 'Async'.", Justification = "By Design.")]
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>. Changeset observable.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> Factory function to create the Observable that will provide the values in the result changeset from the given object in the source changeset.</param>
    /// <returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transform factory.</param>
    /// <param name="errorHandler">An <see cref="Action{T}"/> Provides the option to safely handle errors without killing the stream.</param>
    /// <param name="forceTransform">An <see cref="IObservable{T}"/> of <see cref="Func{T, TResult}"/>. Invoke to force a new transform for items matching the selected objects.</param>
    /// <returns>
    /// A transformed update collection.
    /// </returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transform factory.</param>
    /// <param name="errorHandler">An <see cref="Action{T}"/> error handler.</param>
    /// <param name="forceTransform">An <see cref="IObservable{T}"/> of <see cref="Func{T, TResult}"/>. Invoke to force a new transform for items matching the selected objects.</param>
    /// <returns>
    /// A transformed update collection.
    /// </returns>
    ...
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transform factory.</param>
    /// <param name="errorHandler">An <see cref="Action{T}"/> error handler.</param>
    /// <param name="options">The <see cref="TransformAsyncOptions"/> Additional transform options.</param>
    /// <returns>
    /// A transformed update collection.
    /// </returns>
    /// <exception cref="ArgumentNullException">source
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="pivotOn">A <see cref="Func{T, TResult}"/> pivot on.</param>
    /// <param name="predicateChanged">An <see cref="IObservable{T}"/> of <see cref="Func{T, TResult}"/>. Observable to change the underlying predicate.</param>
    /// <returns>An observable which will emit change sets.</returns>
    ...
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="transformFactory">A <see cref="Func{T, TResult}"/> transform factory.</param>
    /// <param name="updateAction">An <see cref="Action{T}"/> Apply changes to the original. Example (previousTransformedItem, newOriginalItem) => previousTransformedItem.Value = newOriginalItem.</param>
    /// <returns>
    /// A transformed update collection.
    /// </returns>
    /// <exception cref="ArgumentNullException">source
    ...
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="observableSelector">A <see cref="Func{T, TResult}"/> Selector which returns the target observable.</param>
    /// <param name="equalityCondition">A <see cref="Func{T, TResult}"/> equality condition.</param>
    ...
    /// <typeparam name="TValue">The type of the value.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="propertyAccessor">An <see cref="Expression{TDelegate}"/> property accessor.</param>
    ...
    /// <typeparam name="TKey">The type of the key.</typeparam>
    /// <param name="source">The source <see cref="IObservable{T}"/> of <see cref="IChangeSet{TObject, TKey}"/>.</param>
    /// <param name="reasons">The <see cref="ChangeReason"/> values reasons.</param>
