...
{
    public static IObservable<IChangeSet<TObject, TKey>> AutoRefreshOnObservable2<TObject, TKey, TAny>(
        ...
        where TKey : notnull
    {
        ...
        return (changeSetBuffer is null) 
            ? Observable.Create<IChangeSet<TObject, TKey>>(downstreamObserver => AutoRefreshOnObservable2Subscription
