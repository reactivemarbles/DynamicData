...
namespace DynamicData.Binding.WinUI3UWP
{
    ...
    public class ReadOnlyObservableCollection2<T> : IList<T>, IReadOnlyCollection<T>, Microsoft.UI.Xaml.Interop.INotifyCollectionChanged, Microsoft.UI.Xaml.Data.INotifyPropertyChanged
    {
        ...
        public ReadOnlyObservableCollection2(IList<T> list)
        {
        ...
        public ReadOnlyObservableCollection2(IEnumerable<T> collection)
        {
